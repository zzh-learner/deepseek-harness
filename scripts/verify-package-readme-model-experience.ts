...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/session/orb-state': { kind: 'none', reason: 'Client-facing read model folded from already-logged session events; touches no prompt, message, schema, stream, or tool result.' },
